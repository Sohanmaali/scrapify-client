            ...
            <div className="flex justify-between items-center flex-col lg:flex-row md:mt-20">
              <div className="w-full lg:w-1/2">
                ...
                <h2 className="font-manrope text-5xl text-gray-900 font-bold leading-[4rem] mb-7  lg:text-left">
                  ...
                  <span className="text-darkColor">Scrapify</span>
                </h2>
                <p className="text-lg text-gray-500 mb-16 text-center lg:text-left">
                  At <span>Scrapify</span>, we are proud to have a dedicated
                  team of passionate individuals committed to transforming the
                  way recycling works. Our team brings together expertise in
                  technology, sustainability, and customer service to create a
                  platform that empowers communities and promotes a greener
                  future.
                </p>
