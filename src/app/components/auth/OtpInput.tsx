...
const OTPInput: React.FC<OTPInputProps> = ({data,length = 4}) => {
    // hooks
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto p-4">
            ...
            <p className='text-center mb-6 text-mutedColor'>We’ve sent a verification code to your registered email address.</p>
            {/* OTP Input Fields */}
            ...
            <div className="flex gap-2 sm:gap-4 mb-6">
              ...
              ${isSubmitting ? 'bg-gray-100 cursor-not-allowed' : 'focus:border-darkColor focus:ring-2 focus:ring-darkColor'} 
