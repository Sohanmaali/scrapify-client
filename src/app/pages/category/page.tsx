...
const CategoryPage = () => {
  ...
  const categoryType = searchParams?.get("type") || "all";  // Get the categoryType parameter from the query
  ...
  useEffect(() => {
    ...
    // console.log("-=-=-=-=-=showingCategory", categoryType);
  }, [categoryType, categoryData]); // Trigger effect when categoryType or categoryData changes
