...
const ProfilePage = () => {
  const InputField = ({ id, name, label, disabled = false, type = "text", placeholder }:any) => (
  ...
  const SelectField = ({ id, name, label, options = [], placeholder }:any) => (
    <div className="relative w-full mt-4">
      <select
        id={id}
        name={name}
  ...
  return (
    <>
      <div className="px-2">
      <div className="w-full flex justify-between aligh-center"><h1 className="text-2xl text-mutedColor font-bold mb-4 border-b-2 border-b border-darkColor ">Profile</h1></div>
