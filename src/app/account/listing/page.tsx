...
const ListingnPage = () => {
    ...
    return (<>
        <div className="px-2">
            <div className="w-full flex justify-between aligh-center"><h1 className="text-2xl text-mutedColor font-bold mb-4 border-b-2 border-b border-darkColor ">Listing</h1></div>
            <div>

                {/* Tab Navigation */}
                <div className="flex space-x-4 mb-6">
                    <button
                        className={`py-2 px-2 rounded-lg ${activeTab === "scrapMaterial"
                    ...
                    <button
                        className={`py-2 px-4 rounded-lg ${activeTab === "handmadeProducts"
                            ? "bg-darkColor  text-relatedWhite "
                            : "bg-gray-200 text-darkColor"
                            }`}
                    ...
                    {activeTab === "handmadeProducts" && (
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-auto-fit gap-6">
                                {[1, 2, 3, 4, 5, 6, 7, 8, 9, 8, 7, 6, 5, 4, 3, 2, 2, 1, 3, 4, 5, 6, 6, 7, 7, 8, 7, 6, 4, 3, 33, 4].map((item, index) => (
